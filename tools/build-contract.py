...
paths['/api/v1/accommodations']['get']['x-implementation-status']='implemented'
contract={'openapi':'3.0.3','info':{'title':'Ecotrip internal API','version':'1.0.0','description':'Contrat MVP. /health et le catalogue d’hébergements synthétique hors ligne sont implémentés; les autres endpoints métier restent planifiés. Même origine, pas de compte ni réservation.'},'servers':[{'url':'/'}],'paths':paths,'components':{'schemas':S}}
