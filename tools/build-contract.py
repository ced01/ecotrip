...
contract={'openapi':'3.0.3','info':{'title':'Ecotrip internal API','version':'1.2.0','description':'Contrat MVP. Le catalogue, les capabilities et la recherche de trajets utilisent des scénarios synthétiques hors ligne explicitement marqués demo. Aucun compte, réservation, horaire ou offre réelle.'},'servers':[{'url':'/'}],'paths':paths,'components':{'schemas':S}}
