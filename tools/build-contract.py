...
contract={'openapi':'3.0.3','info':{'title':'Ecotrip internal API','version':'1.1.0','description':'Contrat MVP. /health et /api/v1/methodology sont implémentés; les autres endpoints métier restent planifiés. Les exemples sont synthétiques et hors ligne. Même origine, pas de compte ni réservation.'},'servers':[{'url':'/'}],'paths':paths,'components':{'schemas':S}}
